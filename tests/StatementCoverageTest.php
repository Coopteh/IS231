...
class StatementCoverageTest extends TestCase
{
    ...
    public function testCalculate_ThrowsException_WhenAmountIsZeroOrNegative(): void
    {
        ...
        $this->service->calculate(25, false, 0.0);
    }

    public function testCalculate_ReturnsZero_WhenAmountLessOrEqual500(): void
    {
        $result = $this->service->calculate(25, false, 500.0);
    ...
    public function testCalculate_ReturnsZero_WhenAmountOver500ButNoConditions(): void
    {
        $result = $this->service->calculate(30, false, 750.0);
